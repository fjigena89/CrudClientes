<%-- 
    Document   : editar
    Created on : 27 dic 2022, 20:21:00
    Author     : Florencia
--%>
...
<html>
    ...
    <body>        
        <div class="container" >
		    ...
		    %>
                    <form class="p-5" method="POST" action="ClientesController?accion=actualizar">
                         <div class="mb-2">
                            <label for="id" class="form-label" >id</label>
                            <input type="text" class="form-control" id="id" name="id" readonly="true" value=<%=resultado.getIdCliente() %> >                          
                        </div> 
                        <div class="mb-2">
